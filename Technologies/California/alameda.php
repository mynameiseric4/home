...
<html>
<head>
<title>Hilix &middot; Alameda</title>
       ...
       <p>
        <h2 style="font-family:'Open Sans', 'sans-serif'; float:left; padding-left:10px; color:lightgrey; margin-left:65px; padding-bottom:2px; cursor:default">
          <a class="three" href="http://localhost:8888/Hilix/HD/database.php">
            ...
            <span style="color:#9d9d9d; font-size:15px">ALAMEDA</span>
        <h2>
      </p>
    </div>
...
<tr>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3">
      <div class="thumbnail">
        <div class="caption" style="font-size:13px; margin-left:20px">
          <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Alameda</a></h5>
          <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
                <br>
                <br>
                <a class="six" href="#">Local courts:</a>
                <br> 
                <br>
                <br>
                <a class="six" href="#">School boards:</a>
                <br>
                <br>
                <br>
                <a class="six" href="#">Local ballot measures:</a>
                <br>
                <br>
                <a class="six" href="#">Recall</a>
              </td> 
              <td style="vertical-align:top; padding-left:20px">
                <a class="six" href="#">City elections</a>
                <br>
                <br>
                <br>
                <a class="six" href="#">Judicial elections</a>
                <br>
                <br>
                <a class="six" href="#">School board elections</a>
                <br>
                <br>
                <a class="six" href="#">Local measure elections</a>
                <br>
                <br>
                <a class="six" href="#">Recall elections</a>
              </td>
            </tr>
          </table>
        </div>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
        <div class="caption" style="font-size:13px; margin-left:20px">
          <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Albany</a></h5>
          <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
        <div class="caption" style="font-size:13px; margin-left:20px">
          <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Albrae</a></h5>
          <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
        <div class="caption" style="font-size:13px; margin-left:20px">
          <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Altamont</a></h5>
          <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
...
<tr>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Asco</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Ashland</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Baumberg</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Berkeley</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
...
<table style="width:100%; border-bottom:50px solid #f8f8f8">
<tr>
  <td height="300" style="background-image:url(1.jpg); background-repeat: no-repeat"> 
    <!-- Src: <a href="http://www.freepik.com/free-vector/polygonal-abstract-background-design_719712.htm">Designed by Freepik</a> -->
    <div class="row" style="width:100%; padding-left:32px; padding-top:20px">
    <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Brightside</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Brookshire</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Carpenter</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Castro Valley</a></h5>
        <table style="width:90%">
            <tr>
              <td style="vertical-align:top; border-right:1px solid white">
                <a class="six" href="#">Municipal Government:</a>
