  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
       ...
       <p>
        <h2 style="font-family:'Open Sans', 'sans-serif'; float:left; padding-left:10px; color:lightgrey; margin-left:60px; padding-bottom:2px; cursor:default">
...
<tr>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    ...
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:20px">
        <h5><a href="http://localhost:8888/Hilix/Profile/puremathematics.html">Alameda County</a></h5>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3">
    <div class="thumbnail">
      <div class="caption" style="font-size:13px; margin-left:80px">
