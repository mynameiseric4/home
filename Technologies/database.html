...
.glyphicon-triangle-left:hover{color:lightgrey!important;}
.glyphicon-triangle-right:hover{color:lightgrey!important;}
...
<div style="background:#f8f8f8">
  <table class="style2" align="center">
    <tr>
      <td><a class="one">Mathematics</a></td>
      <td><a class="one">Applied mathematics</a></td>
      <td style="padding-right:10px"><a class="one">Statistics</a></td>
      <td>
        <div class="w3-content w3-display-container" style="width:500px; transition-duration: 2s;">
          <div class="mySlides" align="center">
            <table>
              <tr>
                <td>
                  <a class="one" href="http://localhost:8888/Hilix/HD/algebra.php">Algebra</a>
                  <a class="one" style="margin-left:10px">Analysis</a>
                  <a class="one" style="margin-left:10px">Category theory</a>
                  <a class="one" href="http://localhost:8888/Hilix/HD/california.php" style="margin-left:10px">Combinatorics</a>
                  <a class="one" style="margin-left:10px">Control theory</a>
                  <a class="one" style="margin-left:10px">Cry...</a>
                </td>
              </tr>
            </table>
          </div>
          <div class="mySlides" align="center">
            <table>
              <tr>
                <td>
                  <a class="one" href="http://localhost:8888/Hilix/HD/algebra.php">Cryptography</a>
                  <a class="one" style="margin-left:10px">Dynamical systems</a>
                  <a class="one" style="margin-left:10px">Game theory</a>
                  <a class="one" href="http://localhost:8888/Hilix/HD/california.php" style="margin-left:10px">Geometry</a>
                  <a class="one" style="margin-left:10px">Graph the...</a>
                </td>
              </tr>
            </table>
          </div>
          <div class="mySlides" align="center">
            <table>
              <tr>
                <td>
                  <a class="one" href="http://localhost:8888/Hilix/HD/algebra.php">Graph theory</a>
                  <a class="one" style="margin-left:10px">Mathematical biology</a>
                  <a class="one" style="margin-left:10px">Mathematical chemistry</a>
                  <a class="one" style="margin-left:10px">Mathemat...</a>
                </td>
              </tr>
            </table>
          </div>

          <a class="w3-display-left" onclick="plusDivs(-1)"><span class="glyphicon glyphicon-triangle-left" style="color:#9d9d9d"></span></a>
          <a class="w3-display-right" onclick="plusDivs(1)"><span class="glyphicon glyphicon-triangle-right" style="color:#9d9d9d"></span></a>
        </div>
      </td>
      <td style="padding-left:10px"><a class="one">Physics</a></td>
      <td><a class="one">Computer science</a></td>
      <td><a class="one">Linguistic theory</a></td>
    </tr>
  </table>
</div>
    ...
    <!-- Src: <a href="http://www.freepik.com/free-vector/polygonal-abstract-background-design_719712.htm">Designed by Freepik</a> -->
      <div class="row" style="width:100%; padding-left:32px; padding-top:20px">
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/algebra.php">Algebra</a></h5>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Analysis</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Category theory</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Combinatorics</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
    ...
    <td height="300" style=  "background: radial-gradient(white, #f2f2f2, lightgrey)"> 
      <div class="row" style="width:100%; padding-left:32px; padding-top:20px">
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Control theory</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Cryptography</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Dynamical Systems</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="thumbnail">
            <div class="caption">
              <h5><a href="http://localhost:8888/Hilix/HD/alabama.php">Game theory</a></h5>
              <table style="width:100%; border-left: 1px solid white">
                <tr>
                  <td style="vertical-align:top">
                    &mdash;<i class="fa fa-database" aria-hidden="true"></i> <a class="county" href="#">Foundations</a> 
